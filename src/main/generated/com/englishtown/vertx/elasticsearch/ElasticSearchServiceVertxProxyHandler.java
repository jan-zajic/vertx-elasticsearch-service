  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "index": {
          service.index(json.getJsonObject("options") == null ? null : new com.englishtown.vertx.elasticsearch.IndexOptions(json.getJsonObject("options")), createHandler(msg));
          break;
        }
        case "update": {
          service.update(json.getJsonObject("options") == null ? null : new com.englishtown.vertx.elasticsearch.UpdateOptions(json.getJsonObject("options")), createHandler(msg));
          break;
        }
        case "bulk": {
          service.bulk(json.getJsonObject("options") == null ? null : new com.englishtown.vertx.elasticsearch.BulkOptions(json.getJsonObject("options")), createHandler(msg));
          break;
        }
        case "get": {
        ...
        case "delete": {
          service.delete(json.getJsonObject("options") == null ? null : new com.englishtown.vertx.elasticsearch.DeleteOptions(json.getJsonObject("options")), createHandler(msg));
          break;
        }
        case "suggest": {
